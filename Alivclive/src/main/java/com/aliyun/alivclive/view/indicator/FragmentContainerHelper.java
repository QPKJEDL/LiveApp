...
public class FragmentContainerHelper {
    private List<CustomIndicator> mMagicIndicators = new ArrayList<CustomIndicator>();
    ...
    public FragmentContainerHelper(CustomIndicator magicIndicator) {
    ...
    public void attachMagicIndicator(CustomIndicator magicIndicator) {
        mMagicIndicators.add(magicIndicator);
    }

    private void dispatchPageSelected(int pageIndex) {
        for (CustomIndicator magicIndicator : mMagicIndicators) {
