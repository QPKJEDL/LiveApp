...
import com.aliyun.alivclive.utils.AlivcCommon;

public class AlivcMusicAdapter extends RecyclerView.Adapter<AlivcMusicAdapter.MusicViewHolder> {

    private Context mContext;

    private AlivcMusicDialog.OnItemClick mOnItemClick = null;
    ...
    public AlivcMusicAdapter(Context context) {
        this.mContext = context;
        MusicInfo info = new MusicInfo(mContext.getResources().getString(R.string.no_music), "", "", "");
        musicList.add(info);
        ArrayList<MusicInfo> list = AlivcCommon.getResource();
    ...
    public void setOnItemClick(AlivcMusicDialog.OnItemClick onItemClick) {
    ...
    public void updateProgress(MusicViewHolder holder, long progress, long totalTime) {
        if(holder != null && mPosition != 0) {
            ...
            holder.tvPlayTime.setText(AlivcCommon.getTime(progress));
            holder.tvTotalTime.setText(AlivcCommon.getTime(totalTime));
        }
    }
