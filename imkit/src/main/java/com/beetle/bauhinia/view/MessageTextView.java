...
import com.beetle.bauhinia.UserRoomBean;
...
public class MessageTextView extends MessageContentView {
    ...
    public void setMessage(IMessage msg) {
        ...
        if (mediaType == MessageContent.MessageType.MESSAGE_TEXT) {
            ...
            String text = msg.content.getRaw();
            UserRoomBean user = new Gson().fromJson(text, UserRoomBean.class);
            content.setText(EmoticonManager.getInstance().getEmoticonStr(user.getText()));
        }
