package com.qingpeng.mz.video.myview;
...
public class PushBeautyDialog extends DialogFragment {
    ...
    private LiveBottomBar.BeautyListener mBeautyListener;
...
//        mBigEyeBar.setProgress(SharedPreferenceUtils.getBigEye(getActivity().getApplicationContext()));
    ...
    public void setBeautyListener(LiveBottomBar.BeautyListener beautyListener) {
